 ...
 *
 */
public class Auto_33_4_Deliver_Left_Scale_From_Right_00_To_Plate extends CommandGroup {
	...
	private static final double ROBOT_DISTANCE_CROSS_FIELD 		= 25.0;
	private static final double ROBOT_TURN_TO_SCALE 			= 0.0;		//Angles are Field Orientated
	private static final double ROBOT_DISTANCE_TO_OVER_SCALE 	= 4.0;
	
    public Auto_33_4_Deliver_Left_Scale_From_Right_00_To_Plate() {
    	...
    	addSequential(	new Scissor_To_Setpoint(Scissor.SCALE,true),3);//, 3);,Constants.kScissorToSetpointTimout_S);//5 Scissor to Scale Height
    	...
    	addSequential(	new Intake_Launch(-400),1);														//9 Launch Cube
    	
    	addParallel(	new Drive_For_Distance(0.0, -0.4, 0.0, 3));											//10 Back Away from plate

 ...
 *
 */
public class Auto_13_4_Deliver_Right_Scale_From_Left_00_To_Plate extends CommandGroup {
	...
	private static final double ROBOT_TURN_TO_SCALE 			= 0.0;
	private static final double ROBOT_DISTANCE_TO_OVER_SCALE 	= 4.0;
	
    public Auto_13_4_Deliver_Right_Scale_From_Left_00_To_Plate() {
    	...
    	addParallel(	new Scissor_To_Setpoint(Scissor.SWITCH,true),3);
    	...
    	addParallel(	new Wrist_Down(1));	
    	addSequential(	new Drive_Turn_To_Setpoint(0.0, 0.0, ROBOT_TURN_TO_SCALE),1);//, 3);					//4 Turn To Scale
    	...
    	//addSequential(	new Auto_Util_TimeDelay(.1));														//8 Settle Time
    	addSequential(	new Intake_Launch(-600),1);														//9 Launch Cube

 ...
 *
 */
public class Auto_21_5_1_Deliver_Cube_2_Left_Switch extends CommandGroup {

	//Secdond Cube Moves
	private static double ROBOT_DRIVE_FROM_SECOND_CUBE_MOVE_1 = 7.25; //Get move from to command
	private static double ROBOT_CUBE_2_TO_SWITCH_MOVE_1 = 7;
	private static double ROBOT_DRIVE_BACK_AWAY_SWITCH_MOVE = 6.25;
		
    public Auto_21_5_1_Deliver_Cube_2_Left_Switch() {
    	...
    	addSequential(new Drive_Turn_To_Setpoint(0.0, 0.0, 0.0),.25);								//5 Turn back to Switch

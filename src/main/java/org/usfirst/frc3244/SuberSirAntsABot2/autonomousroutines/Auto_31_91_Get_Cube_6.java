 ...
 *
 */
public class Auto_31_91_Get_Cube_6 extends CommandGroup {
	private static final double ROBOT_TO_CUBE6_MOVE_1 = 12;
	private static final double ROBOT_TO_CUBE6_ANGLE = -135.0;
	private static final double ROBOT_SEEK_TO_SECOND_CUBE_MOVE_1 = 3;
	private static final double ROBOT_SEEK_BACK_AWAY_CUBE_MOVE = 1;
    public Auto_31_91_Get_Cube_6() {
    	
    	addParallel(new Intake_Open());
    	addSequential(new Drive_For_Distance(0.6, 0.0, 0.0, ROBOT_TO_CUBE6_MOVE_1),90);	
    	
    	
    	//Make sure all Steps are complete
    	addSequential(new WaitForChildren());
    	
    	addSequential(new Drive_Turn_To_Setpoint(0.0, 0.0, ROBOT_TO_CUBE6_ANGLE));
    	...
    	addSequential(new Auto_31_93_0_Conditional_SecondPlate());

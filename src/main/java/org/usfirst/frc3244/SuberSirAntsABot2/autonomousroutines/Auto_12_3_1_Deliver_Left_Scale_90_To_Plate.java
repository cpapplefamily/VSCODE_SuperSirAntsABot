 ...
 *
 */
public class Auto_12_3_1_Deliver_Left_Scale_90_To_Plate extends CommandGroup {

	private static final double ROBOT_TO_SCALE_ANGLE 		= 90.0;
	private static final double ROBOT_DISTANCE_TO_SCALE 	= 41.5;
	
    public Auto_12_3_1_Deliver_Left_Scale_90_To_Plate() {
    	addParallel(new Wrist_Down(1));																	//1 Prep Wrist
    	addParallel(new Scissor_To_Setpoint(Scissor.SCALE,true),Constants.kScissorToSetpointTimout_S);	//2 Scissor to Scale Height

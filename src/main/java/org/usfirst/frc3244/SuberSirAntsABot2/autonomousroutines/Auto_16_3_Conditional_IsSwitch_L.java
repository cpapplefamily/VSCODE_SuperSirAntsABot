 ...
 *
 */
public class Auto_16_3_Conditional_IsSwitch_L extends ConditionalCommand {

    public Auto_16_3_Conditional_IsSwitch_L() {
      super(new Auto_11_3_Deliver_Left_Switch(), new Auto_00_Reach_BaseLine());
    }
    ...
    protected boolean condition(){
    	...
    	DriverStation.reportError("RUNING: Auto_16_3_Conditional_IsSwitch_L()", false);
    	if(s.length() > 0){

 ...
 *Reviewed
 */
public class Auto_32_4_0_Conditional_Start_Cube2 extends ConditionalCommand {

    public Auto_32_4_0_Conditional_Start_Cube2() {
    	super(new Auto_32_4_1_Left_Get_Cube_6(), new Finnished());
    }

    @Override
    protected boolean condition(){
    	Integer multiCubeChoice = (Integer) Robot.multiCubeChooser.getSelected();
    	DriverStation.reportError("RUNING: Auto_32_4_0_Conditional_Start_Cube2()", false);

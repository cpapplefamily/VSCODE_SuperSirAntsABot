 ...
 *
 */
public class Auto_12_3_2_Deliver_Left_Scale_45_To_Plate extends CommandGroup {

	private static final double ROBOT_DISTANCE_TO_SCALE 	= 35.0;
	//private static final double ROBOT_DISTANCE_TO_SCALE2 	= 2.0;
	private static final double ROBOT_TO_SCALE_ANGLE 		= 20.0;
	
    public Auto_12_3_2_Deliver_Left_Scale_45_To_Plate() {
    	...
    	addParallel(new Drive_For_Distance(0.0, -0.3, 0.0, 1));											//9 Back Away from plate
    	...
    	addSequential(new Auto_12_4_0_Conditional_Start_Cube2());
    }
}

 ...
 *Reviewed
 */
public class Auto_12_4_1_Left_Get_Cube_1 extends CommandGroup {
    ...
    public Auto_12_4_1_Left_Get_Cube_1() {
    	addParallel(new Scissor_To_Setpoint(Scissor.DOWN,true),5);
    	addParallel(new Intake_Open());																	//Open Intakes
    	addSequential(new Drive_Turn_To_Setpoint(0.0, 0.0, ROBOT_TURN_TO_CUBE),3);	
    	
    	addSequential(new WaitForChildren());
    	
    	addSequential(new Drive_For_Distance(-0.1, 0.5, 0.0, ROBOT_DRIVE_TO_SECOND_CUBE_MOVE_1, ROBOT_TURN_TO_CUBE));	//Get closer to Cube
    	...
    	addSequential(new Drive_Seek_Target(0.0,0.3,ROBOT_SEEK_TO_SECOND_CUBE_MOVE_1),3);  //Seek Cube for 4 sec max
    	...
    	addSequential(new Auto_12_5_0_Conditional_WhatPlate());
    }
}

 ...
 *
 */
public class Auto_35_4_1_Deliver_Switch_Left_From_Right_at90 extends CommandGroup {
	...
	private static final double ROBOT_TURN_TO_SWITCH 			= -179.0;
	private static final double ROBOT_DISTANCE_TO_OVER_SCALE 	= 2.0;
	
    public Auto_35_4_1_Deliver_Switch_Left_From_Right_at90() {
    	...
    	addSequential(new CommandGroup() {
    		{
    	    	...
    	    	addSequential(	new Scissor_To_Setpoint(Scissor.SWITCH,true));//, 3);,Constants.kScissorToSetpointTimout_S);//5 Scissor to Scale Height
    		}
    	});
    	...
    	addSequential(new CommandGroup() {
    		{
    			...
    			addSequential(	new Drive_For_Distance(0.0, 0.3, 0.0, ROBOT_DISTANCE_TO_OVER_SCALE),2);				//7 Drive to Scale
    		}
    	});

 ...
 *
 */
public class Auto_15_2_Conditional_IsSwitch_L_R extends ConditionalCommand {

    public Auto_15_2_Conditional_IsSwitch_L_R() {
      super(new Auto_11_3_Deliver_Left_Switch(), new Auto_15_4_0_Conditional_Approach_Right_Switch());
    }

    @Override
    protected boolean condition(){
    	String s = Robot.gameData;
    	DriverStation.reportError("RUNING: Auto_15_2_Conditional_IsSwitch_L_R()", false);
    	if(s.length() > 0){

 ...
 *
 */
public class Auto_14_2_Conditional_IsSwitch_L extends ConditionalCommand {

    public Auto_14_2_Conditional_IsSwitch_L() {
      super(new Auto_11_3_Deliver_Left_Switch(), new Auto_13_1_Start_Left_Deliver_IF_Lscale_Rscale());
    }

    @Override
    protected boolean condition(){
    	String s = Robot.gameData;
    	DriverStation.reportError("RUNING: Auto_14_2_Conditional_IsSwitch_L()", false);
    	if(s.length() > 0){

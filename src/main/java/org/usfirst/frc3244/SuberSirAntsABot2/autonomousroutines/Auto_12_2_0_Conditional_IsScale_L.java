 ...
 *
 */
public class Auto_12_2_0_Conditional_IsScale_L extends ConditionalCommand {

    public Auto_12_2_0_Conditional_IsScale_L() {
      ...
      super(new Auto_12_3_0_Conditional_Approach_Left_Scale(), new Auto_00_Reach_BaseLine());
    }

    @Override
    protected boolean condition(){
    	String s = Robot.gameData;
    	DriverStation.reportError("RUNING: Auto_12_2_0_Conditional_IsScale_L()", false);
    	if(s.length() > 0){

...
public class Winch extends Subsystem {
	...
	public static final double Winch_TAKE_UP = 16;
	public static final double WINCH_DISTANCE = 39;//35
	private boolean m_climbStarted = false;
	
	private double m_targetEncoderValue = 0;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    private final WPI_TalonSRX motor = RobotMap.winchmotor;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    private final DoubleSolenoid double_Solenoid_ClimbHooks = RobotMap.intakeDouble_Solenoid_ClimbHooks;
    ...
    // member variables for Motors drive
 	...
 	public void init() {
		...
		// Set up the TalonSRX closed loop / open loop mode for each wheel
 		//double_Solenoid_ClimbHooks.set(Value.kForward);;
 		my_RetractHooks();
 		//double_Solenoid_ClimbHooks.set(Value.kOff);
    ...
    public void my_setClimbStarted(boolean b) {
    	m_climbStarted = b;
    }
    
    public boolean my_get_ClimbStarted() {
    	return m_climbStarted;
    }
	...
	public void my_extendHooks() {
		double_Solenoid_ClimbHooks.set(Value.kReverse);
		
	}
	
	public void my_RetractHooks() {
		double_Solenoid_ClimbHooks.set(Value.kForward);
